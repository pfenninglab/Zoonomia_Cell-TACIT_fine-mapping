...
CTS_FN=${SETDIR}/data/tidy_data/Zoonomia_data/caudate_zoonomia_mapped_predActive.${CELL}.${POP}.hg38.celltypes.ldcts
...
OUT=${OUTDIR}/caudate_zoonomia_mapped_predActive.${GWAS_Label}.${POP}.${CELL}.${LAB}
...
awk ' FNR == 2 || NR==1 {print}' \
	...
	gzip >  ${OUTDIR}/caudate_zoonomia_mapped_predActive.${GWAS_Label}.${POP}.${CELL}.agg.gz
