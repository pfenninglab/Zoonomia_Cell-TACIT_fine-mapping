...
parser.add_argument("-r", default=4, help="Memory to request in GB", type=float)
...
print("Rscript enhancer_" + args.q + ".r $tree $preds $species $traits $out ${SLURM_ARRAY_TASK_ID}", int(args.n), int(args.s), "$seed", args.b)
