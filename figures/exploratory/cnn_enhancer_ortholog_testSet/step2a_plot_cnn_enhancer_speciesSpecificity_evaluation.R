...
pred2 = input %>% mutate(
  ...
  filter(model_type == 'nonCellEnhLargeGC') 

pdf('plots/cross_species_specific_testSet_performance_20211109.pdf', 
...
ggplot(data = pred2, aes(x = trainingSet, y = value)) + 
  ...
  scale_fill_carto_d(name = "Genome origin of OCR positives and negatives:", palette = "Bold") +
  ...
  ggtitle('Species-Specific Test Performance') + 
  xlab('') + ylab('Accuracy') + 
