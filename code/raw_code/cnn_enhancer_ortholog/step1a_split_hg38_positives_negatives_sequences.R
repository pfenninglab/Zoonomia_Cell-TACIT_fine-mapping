...
lengths(human_enhList) / lengths(human_peakList) ## 55% are noncoding
...
# 66.400    69.138    48.074    76.319    75.929    56.381    47.053    52.562 
...
# Astro INT_Pvalb Microglia    MSN_D1    MSN_D2    MSN_SN     Oligo       OPC 
# 37.704    40.336    34.326    74.236    75.873    27.609    23.354    24.657

## ratio of positives to non-enhancer orthologs
lengths(human_enhList) / lengths(nonEnh_peakList)
# Astro INT_Pvalb Microglia    MSN_D1    MSN_D2    MSN_SN     Oligo       OPC 
# 1.761086  1.714052  1.400513  1.028059  1.000738  2.042124  2.014773  2.131727 
