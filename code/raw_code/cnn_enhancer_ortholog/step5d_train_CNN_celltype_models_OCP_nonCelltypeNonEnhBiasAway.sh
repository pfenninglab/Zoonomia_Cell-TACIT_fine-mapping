...
#SBATCH --job-name=vCell
#SBATCH --gres=gpu:1
#SBATCH --mem=93G
#SBATCH --array=1-40%7
#SBATCH --error=logs/cnn_ocp_d_nonCelltypeNonEnhBiasAway10x_%A_%a.txt
#SBATCH --output=logs/cnn_ocp_d_nonCelltypeNonEnhBiasAway10x_%A_%a.txt
...
cat $DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_train_nonEnhNeg.fa.gz \
	...
	$DATADIR/fasta/rheMac10_${CELLTYPE}_fold${FOLD}_train_nonEnhNeg.fa.gz \
	$DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_train_biasAway10x.fa.gz \
	$DATADIR/fasta/mm10_${CELLTYPE}_fold${FOLD}_train_biasAway10x.fa.gz \
	$DATADIR/fasta/rheMac10_${CELLTYPE}_fold${FOLD}_train_biasAway10x.fa.gz \
	$DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_train_nonCelltypeNeg.fa.gz \
	$DATADIR/fasta/mm10_${CELLTYPE}_fold${FOLD}_train_nonCelltypeNeg.fa.gz \
	$DATADIR/fasta/rheMac10_${CELLTYPE}_fold${FOLD}_train_nonCelltypeNeg.fa.gz > $TRAINNEGFILE
fi
...
cat $DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_valid_nonEnhNeg.fa.gz \
	...
	$DATADIR/fasta/rheMac10_${CELLTYPE}_fold${FOLD}_valid_nonEnhNeg.fa.gz \
	$DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_valid_biasAway10x.fa.gz \
	$DATADIR/fasta/mm10_${CELLTYPE}_fold${FOLD}_valid_biasAway10x.fa.gz \
	$DATADIR/fasta/rheMac10_${CELLTYPE}_fold${FOLD}_valid_biasAway10x.fa.gz \
	$DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_valid_nonCelltypeNeg.fa.gz \
	$DATADIR/fasta/mm10_${CELLTYPE}_fold${FOLD}_valid_nonCelltypeNeg.fa.gz \
	$DATADIR/fasta/rheMac10_${CELLTYPE}_fold${FOLD}_valid_nonCelltypeNeg.fa.gz > $VALIDNEGFILE
fi
...
cat $DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_train_nonEnhNeg.fa.gz \
	$DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_train_biasAway10x.fa.gz \
	$DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_train_nonCelltypeNeg.fa.gz > $TRAINNEGFILE
fi
...
cat $DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_valid_nonEnhNeg.fa.gz \
	$DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_valid_biasAway10x.fa.gz \
	$DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_valid_nonCelltypeNeg.fa.gz > $VALIDNEGFILE
fi
