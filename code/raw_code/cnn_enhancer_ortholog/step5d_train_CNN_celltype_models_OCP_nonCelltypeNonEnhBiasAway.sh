...
cat $DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_train_nonEnhNeg.fa \
	...
	$DATADIR/fasta/rheMac10_${CELLTYPE}_fold${FOLD}_train_biasAway10x.fa \
	$DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_train_nonCelltypeNeg.fa \
	$DATADIR/fasta/mm10_${CELLTYPE}_fold${FOLD}_train_nonCelltypeNeg.fa \
	$DATADIR/fasta/rheMac10_${CELLTYPE}_fold${FOLD}_train_nonCelltypeNeg.fa > $TRAINNEGFILE
fi
...
cat $DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_valid_nonEnhNeg.fa \
	...
	$DATADIR/fasta/rheMac10_${CELLTYPE}_fold${FOLD}_valid_biasAway10x.fa \
	$DATADIR/fasta/hg38_${CELLTYPE}_fold${FOLD}_valid_nonCelltypeNeg.fa \
	$DATADIR/fasta/mm10_${CELLTYPE}_fold${FOLD}_valid_nonCelltypeNeg.fa \
	$DATADIR/fasta/rheMac10_${CELLTYPE}_fold${FOLD}_valid_nonCelltypeNeg.fa > $VALIDNEGFILE
fi
