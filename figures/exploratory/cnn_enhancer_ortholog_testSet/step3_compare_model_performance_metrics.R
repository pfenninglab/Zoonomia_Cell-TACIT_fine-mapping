...
PROJDIR='figures/exploratory/cnn_enhancer_ortholog_testSet'
...
table_out = here(PROJDIR, 'tables', 'Data_S12_Cell-TACIT_model_testSet_performance_values_A.xlsx')
...
## negative to positive ratios across various negative sets
df_long2 = pred2 %>% pivot_longer(cols = c('auPRC.adj','auROC','npv', 'tpr', 'tnr'), 
                                  values_to ='value',  names_to = 'variable')
## write performance metrics out to table
table_out2 = here(PROJDIR, 'tables', 'Data_S12_Cell-TACIT_model_testSet_performance_values_B.xlsx')
...
pred3_fn = list.files(path = here('data/raw_data','cnn_enhancer_ortholog','predictions'), 
                     pattern = 'Only_nonEnh_test.performance.feather', full.names = T, recursive = T)
...
## negative to positive ratios across various negative sets
df_long3 = pred3 %>% pivot_longer(cols = c('auPRC','auROC','tpr', 'npv', 'tnr'),
                                values_to ='value',  names_to = 'variable')
## write performance metrics out to table
table_out3 = here(PROJDIR, 'tables', 'Data_S12_Cell-TACIT_model_testSet_performance_values_C.xlsx')
