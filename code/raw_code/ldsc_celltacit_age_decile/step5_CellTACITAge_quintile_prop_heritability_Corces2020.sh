...
CTS_FN=${DATADIR}/CellTACITage_quintile.${CELL}.${POP}.hg38.celltypes.ldcts
...
OUT=${OUTDIR}/CellTACITage_quintile.Corces2020.${GWAS_Label}.${POP}.${CELL}.${LAB}
...
OUTFILE=${OUTDIR}/CellTACITage_quintile.Corces2020.${GWAS_Label}.${POP}.${CELL}.agg.gz
