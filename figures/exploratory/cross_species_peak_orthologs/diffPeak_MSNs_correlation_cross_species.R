...
humanProj = humanProj[humanProj$Clusters2 %in% cellType, ]
humanMarkersD1 = getMarkerFeatures(
  ArchRProj = humanProj, groupBy = "Clusters2", 
  useGroups = 'MSN_D1',bgdGroups = 'MSN_D2',
  useMatrix = "OrthologPeakMatrix",
  bias = c("TSSEnrichment", "log10(nFrags)"), testMethod = "wilcoxon",
  maxCells = 1000, scaleTo = 10^4,  k = 100, binarize = TRUE)
humanMarkersD2 = getMarkerFeatures(
  ArchRProj = humanProj, groupBy = "Clusters2", 
  useGroups = 'MSN_D2',bgdGroups = 'MSN_D1',
  useMatrix = "OrthologPeakMatrix",
  bias = c("TSSEnrichment", "log10(nFrags)"), testMethod = "wilcoxon",
  maxCells = 1000, scaleTo = 10^4,  k = 100, binarize = TRUE)
humanMarkersSE = cbind(humanMarkersD1, humanMarkersD2)
...
mouseProj = mouseProj[mouseProj$Clusters2 %in% cellType, ]
mouseMarkersD1 = getMarkerFeatures(
  ArchRProj = mouseProj, groupBy = "Clusters2", 
  useGroups = 'MSN_D1',bgdGroups = 'MSN_D2', useMatrix = "OrthologPeakMatrix",
  bias = c("TSSEnrichment", "log10(nFrags)"), testMethod = "wilcoxon",
  maxCells = 1000, scaleTo = 10^4,  k = 100, binarize = TRUE)
mouseMarkersD2 = getMarkerFeatures(
  ArchRProj = mouseProj, groupBy = "Clusters2", 
  useGroups = 'MSN_D2',bgdGroups = 'MSN_D1', useMatrix = "OrthologPeakMatrix",
  bias = c("TSSEnrichment", "log10(nFrags)"), testMethod = "wilcoxon",
  maxCells = 1000, scaleTo = 10^4,  k = 100, binarize = TRUE)
mouseMarkersSE = cbind(mouseMarkersD1, mouseMarkersD2)
...
macaqueProj = macaqueProj[macaqueProj$Clusters2 %in% cellType, ]
macaqueMarkersD1 = getMarkerFeatures(
  ArchRProj = macaqueProj, groupBy = "Clusters2", 
  useGroups = 'MSN_D1',bgdGroups = 'MSN_D2', useMatrix = "OrthologPeakMatrix",
  bias = c("TSSEnrichment", "log10(nFrags)"), testMethod = "wilcoxon",
  maxCells = 1000, scaleTo = 10^4,  k = 100, binarize = TRUE)
macaqueMarkersD2 = getMarkerFeatures(
  ArchRProj = macaqueProj, groupBy = "Clusters2", 
  useGroups = 'MSN_D2',bgdGroups = 'MSN_D1', useMatrix = "OrthologPeakMatrix",
  bias = c("TSSEnrichment", "log10(nFrags)"), testMethod = "wilcoxon",
  maxCells = 1000, scaleTo = 10^4,  k = 100, binarize = TRUE)
macaqueMarkersSE = cbind(macaqueMarkersD1, macaqueMarkersD2)

markerSEList = 
  list(Human = humanMarkersSE, Mouse = mouseMarkersSE, Macaque = macaqueMarkersSE)
system('mkdir -p rdas')
markerRDS_fn = file.path('rdas', 'cross_species_MsnMarkerSEList.rds')
...
corSpearman_df = rbind(
  correlateMarkerSE(se1 = humanMarkersSE, se2 = mouseMarkersSE, 
                    label1 = 'Human', label2 = 'Mouse', method = 'spearman'),
  correlateMarkerSE(se1 =humanMarkersSE, se2 = macaqueMarkersSE, 
...
heatmap_fn = file.path('plots', 'cross_species_MSNmarker_correlation.pdf')

pdf(heatmap_fn, height = 4, width =6)
hm1 = Heatmap(corMatSpearman,
              # matrix parameters
              heatmap_legend_param = list(
                title = expression(paste("Spearman's ", rho)), 
                heatmap_legend_side = "bottom",
                legend_width = unit(2.5, "in"),
              ...
              column_title = "Orthologous Peak Log2FC Correlation",
...
hm2 = Heatmap(corMatPearson,
              ...
              heatmap_legend_param = list(
                ...
                legend_width = unit(2.5, "in"), title_position = "topcenter",
                direction = "horizontal"),
